...
You can also all take a look at the [Changelog file](https://github.com/causemetric/salesforce-app/blob/master/CHANGELOG.md) and see what changed from version to version.
